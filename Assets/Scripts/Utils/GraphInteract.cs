...
public class GraphInteract : MonoBehaviour
{
  ...
  void Start()
  {
    ...
    ControlerInput.instance.triggerActionLeft.action.performed += TriggerLeft;
    ControlerInput.instance.gripActionLeft.action.performed += GripLeft;
    ControlerInput.instance.triggerActionRight.action.performed += TriggerRight;
    ControlerInput.instance.gripActionRight.action.performed += GripRight;
  ...
  private void GripLeft(InputAction.CallbackContext a)
  {
  ...
  private void GripRight(InputAction.CallbackContext a)
  {
    if (!isLeftController ^ isLeftHanded)
    {
      Grip(a);
  ...
  private void TriggerLeft(InputAction.CallbackContext a)
  {
    if (isLeftController ^ isLeftHanded)
    {
      Trigger(a);
